...
namespace ApiColomiersVolley.DAL.Migrations
{
    ...
    [Migration("20250927193957_ajout_parametres")]
    partial class ajout_parametres
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiColomiersVolley.DAL.Entities.Adherent", b =>
                {
                    ...
                    b.Property<string>("Alert1")
                        .HasColumnType("varchar(500)")
                        .HasColumnName("alert1");

                    b.Property<string>("Alert2")
                        .HasColumnType("varchar(500)")
                        .HasColumnName("alert2");

                    b.Property<string>("Alert3")
                        .HasColumnType("varchar(500)")
                        .HasColumnName("alert3");
                    ...
                    b.Property<string>("VerifC3L")
                        .HasColumnType("varchar(500)")
                        .HasColumnName("verif_c3l");
            ...
            modelBuilder.Entity("ApiColomiersVolley.DAL.Entities.Order", b =>
                {
                    ...
                    b.Property<int?>("CotisationC3L")
                        .HasColumnType("int")
                        .HasColumnName("cotisation_c3l");
            ...
            modelBuilder.Entity("ApiColomiersVolley.DAL.Entities.Parametres", b =>
                {
                    ...
                    b.Property<bool>("AdoOpened")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("adoOpened");

                    b.Property<bool>("CompetOpened")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("competOpened");

                    b.Property<string>("InscriptionFilter")
                        .HasColumnType("varchar(500)")
                        .HasColumnName("inscriptionFilter");

                    b.Property<bool>("InscriptionOpened")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("inscriptionOpened");

                    b.Property<bool>("LoisirOpened")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("loisirOpened");

                    b.Property<int>("NbAdoMax")
                        .HasColumnType("int")
                        .HasColumnName("nbAdoMax");

                    b.Property<bool>("Reinscription")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("reinscription");

                    b.Property<string>("SubHeader")
                        .HasColumnType("varchar(800)")
                        .HasColumnName("subHeader");

                    b.Property<int>("TarifAdo")
                        .HasColumnType("int")
                        .HasColumnName("tarifAdo");

                    b.Property<int>("TarifExterior")
                        .HasColumnType("int")
                        .HasColumnName("tarifExterior");

                    b.Property<int>("TarifLicense")
                        .HasColumnType("int")
                        .HasColumnName("tarifLicense");

                    b.Property<int>("TarifLocal")
                        .HasColumnType("int")
                        .HasColumnName("tarifLocal");

                    b.Property<int>("TarifLoisir")
                        .HasColumnType("int")
                        .HasColumnName("tarifLoisir");

                    b.Property<int>("TarifMember")
                        .HasColumnType("int")
                        .HasColumnName("tarifMember");
            ...
            modelBuilder.Entity("ApiColomiersVolley.DAL.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("ApiColomiersVolley.DAL.Entities.User", b =>
                {
                    b.HasOne("ApiColomiersVolley.DAL.Entities.Role", "Role")
                        .WithMany()
